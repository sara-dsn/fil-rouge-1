...
if(isset($_GET["id"])){
 ...
 ?>
                    <div class="card  col-12 col-md-2 ml-4 ">
                        <img class="card-img-top img-fluid mt-2" src="asset/food/<?=$element->image?>" alt="burger360">
                         <div class="card-body">
                            <h5 class="card-title"><?=$element->libelle?></h5>
                          <p class="card-text"><?=$element->description?><br> Total : <?=$element->prix?> €</p>
             ...
             <div class="container-fluid col-12 d-none d-md-block mb-4 mt-4">
                    <div class="row ">
                        ...
                        <form class="col-8 " method="POST" action="DAO.php">
